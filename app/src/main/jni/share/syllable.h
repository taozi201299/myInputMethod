...
#define USER_MAX_SYLLABLES  9      // balance the page size, item num and char num
...
//解析拼音串到音节数组。
extern int ParsePinYinString(TCHAR *pin_yin, SYLLABLE *syllables, int array_length, int fuzzy_mode/*, int *correct_flag, int *separator_flag*/);
...
//反向解析拼音串到音节数组。
extern int ParsePinYinStringReverse(TCHAR *pin_yin, SYLLABLE *syllables, int array_length, int fuzzy_mode, int pinyin_mode/*, int *correct_flag, int *separator_flag*/);
//获取另外的拼音解析方式
...
extern int GetLegalPinYinLength(const TCHAR *pin_yin);
